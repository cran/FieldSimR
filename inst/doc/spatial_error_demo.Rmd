...
To obtain pre-defined target heritabilities at the plot-level, we need to define the total error variances for the two simulated traits relative to their genetic variances. We assume broad-sense heritabilities at the plot level of ***H<sup>2</sup>*** **= 0.1 for grain yield** and ***H<sup>2</sup>*** **= 0.3 for plant height** at all three locations. The heritabilities for the six trait x environment combinations are stored in a single vector.
